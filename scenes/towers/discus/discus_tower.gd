...
func _on_target_area_entered(enemy: Enemy):
	...
	tween.tween_property(sprite_2d, "position", Vector2(0, -600), 0.65)
	tween.tween_property(sprite_2d, "position", target_area.position, 0.3)
	#explode
	...
	tween2.tween_property(sprite_2d, "position", Vector2(0, 0), 0.5)
